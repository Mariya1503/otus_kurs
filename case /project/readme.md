...
•Включите OSPF (area 0) для сетей 192.168.10.0/24, 192.168.20.0/24, 192.168.30.0/24 и 10.0.0.0/24.
...
•Включите OSPF для сетей 172.16.1.0/24 и 10.0.0.0/24.
...
•Проверьте соседей OSPF (show ip ospf neighbor).
...
•применяет OSPF для динамической маршрутизации;
